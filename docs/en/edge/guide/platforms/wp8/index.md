...
- Access them locally from project code generated by the CLI, for
  example in the `platforms/wp8/cordova` directory.
...
Be sure to expand the appropriate archive, `cordova-wp8\wp8` in this
