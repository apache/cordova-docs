...
- __x__:  x 軸上での加速度を表します。 (単位 m/s^2) _(Number)_
- __y__:  y 軸上での加速度を表します。 (単位 m/s^2) _(Number)_
- __z__:  z 軸上での加速度を表します。 (単位 m/s^2) _(Number)_
- __timestamp:__ ミリ秒単位のタイムスタンプ値を表します。 _(DOMTimeStamp)_

概要
-----------

_x_, _y_, _z_ の加速度は重力の影響 (9.81 m/s^2) を含みます。デバイスが机の上に表向きで置かれている場合、値はそれぞれ _x_=0, _y_=0, _z_=9.81 となります。
