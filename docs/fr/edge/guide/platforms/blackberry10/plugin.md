...
Pour créer la partie native de votre plugin, ouvrir l'IDE de NDK 10 BlackBerry et sélectionnez **fichier → nouveau → BlackBerry projet → Extension Native → BlackBerry WebWorks**. Entrez le nom du projet souhaité et l'emplacement, puis appuyez sur **Terminer**.
