...
Oltre l'archiviazione che API elencate sopra, il File API è possibile ai dati della cache del file system locale. Altri [plugins Cordova][5] forniscono opzioni di archiviazione simili.
