...
Per creare la parte nativa del vostro plugin, aprire il BlackBerry 10 NDK IDE e selezionare **File → nuovo → progetto BlackBerry → estensione nativa → BlackBerry WebWorks**. Immettere il nome del progetto desiderato e posizione, quindi premere **fine**.
