...
Для создания родной части вашего плагина, откройте BlackBerry 10 NDK IDE и выберите **файл → новый → ежевика проекта → стандартного расширения → BlackBerry WebWorks**. Введите нужное имя и расположение проекта, затем нажмите кнопку **Готово**.
