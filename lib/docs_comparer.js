    ...
    */
    ...
    DocsComparer.prototype.compareHtml = function (sourceFile, targetFile, relativePath, options) {
        ...
        if (relativePath == "_index.html") {
            if (options.lang == "zh" || options.lang == "ja" || options.lang == "ko") {
                console.log("File " + relativePath + " is skipped for the Asian languages, since this is results in out of memory exception");
                return;
            }
        }
