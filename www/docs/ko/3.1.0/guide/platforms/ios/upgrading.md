...
5.  복사는 `www/cordova.js` (참고 있지 않습니다 버전 접미사 더 이상, 버전은 헤더에서 [파일](../../../cordova/file/fileobj/fileobj.html) 자체에) 파일에 새 프로젝트에서 당신의 `www` 디렉터리 및 삭제 귀하 `www/cordova.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
5.  복사는 `www/cordova.js` (참고 있지 않습니다 버전 접미사 더 이상, 버전은 헤더에서 [파일](../../../cordova/file/fileobj/fileobj.html) 자체에) 파일에 새 프로젝트에서 당신의 `www` 디렉터리 및 삭제 귀하 `www/cordova-2.7.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
7.  업데이트 (또는 교체, 결코 파일을 변경한 경우) 당신의 `AppDelegate.m` 에서 새로운 것에 따라 [파일](../../../cordova/file/fileobj/fileobj.html) (볼 [이 사랑][2] 프로젝트).
...
5.  프로젝트의 복사 `www/cordova-2.6.0.js` 로 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-2.5.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

6.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (다른 파일과 함께 스크립트를 참조 하는) 새로운 참조를 `cordova-2.6.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  업데이트 (또는 교체, 결코 파일을 변경한 경우) 당신의 `AppDelegate.m` 에서 새로운 것에 따라 [파일](../../../cordova/file/fileobj/fileobj.html) (볼 [이 사랑][4] 프로젝트).

8.  당신의 `config.xml` 파일을 [이 새 줄을 추가][5].

9.  당신의 `config.xml` 파일을 [이 새 줄을 추가][6].

10. 당신의 `config.xml` [파일](../../../cordova/file/fileobj/fileobj.html), [UIWebViewBounce, DisallowOverscroll으로 변경 되었습니다 및 기본 값이 다른][7].
...
5.  복사는 `www/cordova-2.5.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 당신의 `www/cordova-2.4.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

6.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-2.5.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  업데이트 (또는 교체, 결코 파일을 변경한 경우) 당신의 `AppDelegate.m` 에서 새로운 것에 따라 [파일](../../../cordova/file/fileobj/fileobj.html) (볼 [이 사랑][8] 프로젝트).

8.  당신의 `config.xml` [파일](../../../cordova/file/fileobj/fileobj.html), [다음 새 줄을 추가][9].

9.  당신의 `config.xml` [파일](../../../cordova/file/fileobj/fileobj.html), [루트 요소를 편집, 위젯 코르도바에서 변경][10].

10. 당신의 `config.xml` [파일](../../../cordova/file/fileobj/fileobj.html), [OpenAllWhitelistURLsInWebView 환경 설정 제거][11].
...
5.  복사는 `www/cordova-2.4.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-2.3.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

6.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-2.4.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  업데이트 (또는 교체, 결코 파일을 변경한 경우) 당신의 `MainViewController.m` 에서 새로운 것에 따라 [파일](../../../cordova/file/fileobj/fileobj.html) (볼 [이 사랑][12] 프로젝트).

8.  업데이트 (또는 교체, 결코 파일을 변경한 경우) 당신의 `AppDelegate.m` 에서 새로운 것에 따라 [파일](../../../cordova/file/fileobj/fileobj.html) (볼 [이 사랑][13] 프로젝트).
...
5.  복사는 `www/cordova-2.3.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-2.2.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

6.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-2.3.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
11. [InAppBrowser](../../../cordova/inappbrowser/inappbrowser.html) 플러그인을 추가 `config.xml` , 아래에이 태그를 추가 하 여 `<cordova><plugins>` :
    
        < 플러그인 이름 = "InAppBrowser" 값 = "CDVInAppBrowser" / >
        

12. 참고-C 플러그인은 더 이상 허용 *하지* . 허용 된 사이트 목록 애플 리 케이 션 허용 된 사이트 목록에와 함께 [연결](../../../cordova/connection/connection.html) 해야 설정 하는 `User-Agent` 헤더를 주요 코르도바 WebView로 같은 사용자 에이전트에 [연결](../../../cordova/connection/connection.html). 액세스 하 여이 얻을 수 있는 `userAgent` 메인 뷰 컨트롤러에서 속성. 기본 뷰 컨트롤러 (CDVViewController)에 또한 있다는 `URLisAllowed` URL는 허용을 통과할지 여부를 확인 하는 방법.

13. [장치](../../../cordova/device/device.html) API 변경:
...
5.  복사는 `www/cordova-2.2.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-2.1.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

6.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-2.2.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
9.  다음으로, 업데이트를 `CordovaLib` 하위 프로젝트가 참조. 코르도바 2.1.0으로 시작, 우리가 사용 하지 않는 CORDOVALIB Xcode [변수](../../../plugin_ref/spec.html) 더 이상 위치를 참조할 때 `CordovaLib` 을 참조는 절대 [파일](../../../cordova/file/fileobj/fileobj.html) 참조 지금.
...
**참고:** 2.2.0,은 `bin/create` 에 복사 스크립트는 `CordovaLib` 프로젝트에 하위 프로젝트. 동일한 종류의 설치를 위해, 그냥 오른쪽에 복사 `CordovaLib` 프로젝트 디렉터리 업데이트에는 `CordovaLib` 하위 프로젝트 Xcode [파일](../../../cordova/file/fileobj/fileobj.html) 관리자에서 (프로젝트)의 상대적인 [위치](../../../cordova/geolocation/Position/position.html).
...
5.  복사는 `www/cordova-2.1.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-2.0.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

6.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-2.1.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
10. 제거는 `VERSION` 프로젝트의 참조 [파일](../../../cordova/file/fileobj/fileobj.html) (*아닌* 것에`CordovaLib`).

11. 다음으로, 업데이트를 `CordovaLib` 하위 프로젝트가 참조. 코르도바 2.1.0으로 시작, 우리가 사용 하지 않는 CORDOVALIB Xcode [변수](../../../plugin_ref/spec.html) 더 이상 위치를 참조할 때 `CordovaLib` 을 참조는 절대 [파일](../../../cordova/file/fileobj/fileobj.html) 참조 지금.
...
3.  복사는 `www/cordova-2.0.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-1.9.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

4.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-2.0.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

5.  복사는 `cordova` 프로젝트의 루트 디렉토리 (만약 당신이 원하는 프로젝트 명령줄 도구)에 새로운 프로젝트에서 디렉토리.

6.  아래에서 새 항목 추가 `Plugins` 에 당신의 `Cordova.plist` **지원 파일** 그룹에서 [파일](../../../cordova/file/fileobj/fileobj.html). 키가 `Device` 값은`CDVDevice`.
...
12. 위치는 `CordovaLib.xcodeproj` 파일에 `CordovaLib` 디렉터리 다음 드래그 앤 드롭으로 프로젝트에 [파일](../../../cordova/file/fileobj/fileobj.html). 그것은 하위 프로젝트로 표시 됩니다.
...
25. 위치는 `VERSION` [파일](../../../cordova/file/fileobj/fileobj.html), (우리는 그것, 아니라 복사에 대 한 링크를 만들 원하는) 주요 프로젝트에 끌어 놓습니다.

26. **어떤 추가 된 폴더에 대 한 그룹 만들기** 라디오 단추를 선택 후 **완료** 버튼을 선택 합니다.

27. 선택은 `VERSION` 파일을 이전 단계에서 드래그 합니다.

28. **파일 관리자** 를 표시 하려면 **옵션-명령-1** 키 조합을 입력 (또는 menuitem **보기 → 유틸리티 → [파일](../../../cordova/file/fileobj/fileobj.html) 속성**).

29. **위치** 에 대 한 드롭 다운 메뉴에 대 한 **파일 관리자** 에서 **CORDOVALIB를 기준으로** 선택.

30. 통합된 헤더를 찾을 수 있도록 **고유**, **Xcode 환경 설정 → [위치](../../../cordova/geolocation/Position/position.html) → 파생 데이터 → 고급...** Xcode 환경 설정.
...
3.  복사는 `www/cordova-1.9.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-1.8.x.js` [파일](../../../cordova/file/fileobj/fileobj.html).

4.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-1.9.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
3.  복사는 `www/cordova-1.8.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-1.7.x.js` [파일](../../../cordova/file/fileobj/fileobj.html).

4.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-1.8.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

[캡처](../../../cordova/media/capture/capture.html) API를 사용 하 여 예정 하는 경우 새로운 **iPad 망막 디스플레이** 자산을 필요 합니다.
...
3.  복사는 `www/cordova-1.7.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-1.6.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

4.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-1.7.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
6.  복사는 `www/cordova-1.6.1.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/cordova-1.5.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `cordova-1.6.1.js` [파일](../../../cordova/file/fileobj/fileobj.html).

8.  새로운 추가 `Cordova.plist` 파일을 프로젝트에. 이것은 코어 플러그인 서비스 이름은 통일 Cordova JavaScript [파일](../../../cordova/file/fileobj/fileobj.html) (안 드 로이드와 블랙베리에서 그들을 일치 하도록 변경 해야 합니다 때문에 필요`cordova-js`).

9.  모든 설정, **플러그인** 및 **ExternalHosts** 항목에 새로운 당신의 **백업 Cordova.plist** 했다 통합`Cordova.plist`.

10. 당신은 당신의 백업에 있는 모든 프로젝트 관련 코드 통합 `AppDelegate.h` 및 `AppDelegate.m` 를 새로운 AppDelegate [파일](../../../cordova/file/fileobj/fileobj.html). 모든 `UIWebViewDelegate` 또는 `CDVCommandDelegate` 에서 코드 `AppDelegate.m` 에 들어갈 필요가 있을 것 이다 `MainViewController.m` 지금 (해당 파일에서 섹션을 주석 참조).

11. 당신은 당신의 백업에 있는 모든 프로젝트 관련 코드 통합 `MainViewController.h` 및 `MainViewController.m` 를 새로운 MainViewController [파일](../../../cordova/file/fileobj/fileobj.html).
...
3.  복사는 `www/cordova-1.5.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/phonegap-1.4.x.js` [파일](../../../cordova/file/fileobj/fileobj.html).

4.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새로운 코르도바를 가리키도록 `cordova-1.5.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
27. 찾기 당신의 `PhoneGap.plist` 프로젝트 탐색기에서 파일을 [파일](../../../cordova/file/fileobj/fileobj.html) 이름에 입력 이름 편집 모드로 한 번 클릭 합니다.
...
4.  복사는 `MainViewController.m` 이전 [파일](../../../cordova/file/fileobj/fileobj.html) 교체 디스크에 1.4.0-based 프로젝트 디렉토리에 새 프로젝트에서 [파일](../../../cordova/file/fileobj/fileobj.html) (백업 [파일](../../../cordova/file/fileobj/fileobj.html) 먼저에서 위의 2 단계).

5.  추가 `MainViewController.m` Xcode 프로젝트에 [파일](../../../cordova/file/fileobj/fileobj.html).
...
6.  복사는 `www/phonegap-1.4.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/phonegap-1.3.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `phonegap-1.4.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

8.  아래에서 새 항목 추가 `Plugins` 에 당신의 `PhoneGap.plist` [파일](../../../cordova/file/fileobj/fileobj.html). 키가 `com.phonegap.battery` 값은`PGBattery`.

9.  당신은 당신의 백업에 있는 모든 프로젝트 관련 코드 통합 `AppDelegate.h` 및 `AppDelegate.m` 를 새로운 AppDelegate [파일](../../../cordova/file/fileobj/fileobj.html).
...
6.  복사는 `www/phonegap-1.3.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/phonegap-1.2.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `phonegap-1.3.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
6.  복사는 `www/phonegap-1.2.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/phonegap-1.1.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `phonegap-1.2.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
6.  복사는 `www/phonegap-1.1.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/phonegap-1.0.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `phonegap-1.1.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
...
6.  복사는 `www/phonegap-1.0.0.js` 에 새로운 프로젝트에서 파일을 `www` 디렉터리 및 삭제 귀하 `www/phonegap-0.9.6.js` [파일](../../../cordova/file/fileobj/fileobj.html).

7.  에 코르 도우 바 스크립트 참조를 업데이트를 `www/index.html` [파일](../../../cordova/file/fileobj/fileobj.html) (및 스크립트 참조를 포함 하는 기타 파일) 새를 가리키도록 `phonegap-1.0.0.js` [파일](../../../cordova/file/fileobj/fileobj.html).
