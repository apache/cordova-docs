...
보고 중지는 `Acceleration` 에 의해 참조 되는 `watchID` 매개 <a href="../../plugin_ref/spec.html">변수</a>.

    navigator.accelerometer.clearWatch(watchID);
    

*   **watchID**: ID 반환`<a href="accelerometer.watchAcceleration.html">accelerometer.watchAcceleration</a>`.
