...
<a href="events.html">이벤트</a> 발생 때 배터리 중요 한 수준 임계값에 도달 했습니다.
...
<a href="events.html">이벤트</a> 발생 때 배터리 충전 비율 배터리 위험 임계값에 도달 했습니다. 값은 <a href="../device/device.html">장치</a> 마다 다릅니다.
