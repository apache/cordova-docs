...
> [장치](../device/device.html) 가리키는 방향을 가져옵니다.
...
*   [compass.watchHeadingFilter](compass.watchHeadingFilter.html) (사용 되지 않음)
*   [compass.clearWatchFilter](compass.clearWatchFilter.html) (사용 되지 않음)
