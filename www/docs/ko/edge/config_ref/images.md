...
이 섹션에서는 응용 프로그램의 아이콘과 코르도바 CLI (<a href="../guide/cli/index.html">명령줄 인터페이스</a>에서 설명)에서 작업할 때 둘 다 다양 한 플랫폼에 대 한 선택적 스플래시 화면을 구성 하는 방법 (플랫폼 <a href="../index.html">가이드</a>에 자세히 설명) 플랫폼 SDK 도구를 사용 하 여 또는.
...
지금 현재 (코르도바 3.5.0 7 월 2014) 다음 <a href="../guide/support/index.html">플랫폼 지원</a> 시작 화면.
