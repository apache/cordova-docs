...
이 <a href="../../../index.html">가이드</a>에서는 구축 하 고 배포 코르도바 애플 리 케이 션 블랙베리 10 장치에 대 한 개발 환경을 설정 하는 방법을 보여 줍니다. 블랙베리의 이전 버전에 대 한 다양 한 블랙베리 <a href="../index.html">플랫폼 <a href="../../../index.html">가이드</a></a>에 설명 된 명령줄 도구를 사용 해야 합니다.
