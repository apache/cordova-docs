...
- __options:__ options for the <a href="inappbrowser.html">InAppBrowser</a> (`String`) (Optional, Default: "location=yes")
    ...
    - __location__ - set to 'yes' or 'no' to turn the location bar on or off for the <a href="inappbrowser.html">InAppBrowser</a> (defaults to 'yes')
    
    iOS and Android only
    --------------------
    - __<a href="inappbrowser.html">close</a>buttoncaption__ - set to a string that will be the caption for the "Done" button. Note that if you set this for iOS, you will have to localize this value yourself.
