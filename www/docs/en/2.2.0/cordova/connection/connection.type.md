...
API Change
----------
Before Cordova 2.2.0, the [Connection](connection.html) object existed at: `navigator.network.connection`.
...
- Windows Phone Emulator always detects `navigator.connection.type` as `[Connection](connection.html).UNKNOWN`.
