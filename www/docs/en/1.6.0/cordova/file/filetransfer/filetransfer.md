...
- __successCallback__ - A callback that is called with a [FileUploadResult](../fileuploadresult/fileuploadresult.html) object. _(Function)_
- __errorCallback__ - A callback that is called if an error occurs uploading the file. Invoked with a [FileTransferError](../filetransfererror/filetransfererror.html) object. _(Function)_
...
- __errorCallback__ - A callback that is called if an error occurs retrieving the [FileEntry](../fileentry/fileentry.html). Invoked with a [FileTransferError](../filetransfererror/filetransfererror.html) object. _(Function)_
