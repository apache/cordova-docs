...
# The config.xml <a href="../cordova/file/fileobj/fileobj.html">File</a>
...
- <a href="../guide/platforms/blackberry10/config.html">BlackBerry Configuration</a>
...
This example <a href="../cordova/inappbrowser/inappbrowser.html">show</a>s the default `config.xml` generated by the CLI's
...
- `<access>` elements define the set of external domains the app is
  allowed to communicate with. The default value <a href="../cordova/inappbrowser/inappbrowser.html">show</a>n above allows
...
- `Fullscreen` allows you to hide the status bar at the top of the
  screen. The default value is `false`. <a href="../cordova/splashscreen/<a href="../cordova/splashscreen/splashscreen.show.html">splashscreen.show</a>.html">Example</a>:

        <preference name="Fullscreen" value="true" />

- `Orientation` allows you to lock orientation and prevent the
  interface from rotating in response to changes in orientation.
  Possible values are `default`, `landscape`, or `portrait`. <a href="../cordova/splashscreen/<a href="../cordova/splashscreen/splashscreen.show.html">splashscreen.show</a>.html">Example</a>:
...
projects:
        ...
        <feature name="<a href="../cordova/device/device.html">Device</a>">
            <param name="android-package" value="org.apache.cordova.device.<a href="../cordova/device/device.html">Device</a>" />
        </feature>
...
See the <a href="../index.html">API Reference</a> for details on how to specify each feature. See
