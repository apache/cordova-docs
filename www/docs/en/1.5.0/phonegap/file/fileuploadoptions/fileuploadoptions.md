...
- __fileKey:__ The [name](../../storage/parameters/name.html) of the form element.  If not set defaults to "file". (DOMString)
- __fileName:__ The file [name](../../storage/parameters/name.html) you want the file to be saved as on the server.  If not set defaults to "image.jpg". (DOMString)
