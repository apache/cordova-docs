...
- __displayName:__ The [name](../../storage/parameters/name.html) of this Contact, suitable for display to end-users. _(DOMString)_
- __name:__ An object containing all components of a persons [name](../../storage/parameters/name.html). _(ContactName)_
- __nickname:__ A casual [name](../../storage/parameters/name.html) to address the contact by. _(DOMString)_
