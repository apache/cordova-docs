...
* Don't forget to add any hosts you connect to in the whitelist, as described in Domain <a href="../../appdev/whitelist/index.html">Whitelist Guide</a>. If you forget, an error is logged in the Xcode console.
