...
<!-- XREF
(See the <a href="../../index.html">API Reference</a> for an overview, and the Application
...
(CLI). (To install the CLI, see <a href="../cli/index.html">The Command-line Interface</a>.)
...
options. 
(See the <a href="../platforms/index.html">Platform Guides</a> for details about each platform's SDK tool set.)
...
<!-- XREF
(See <a href="../../config_ref/index.html">The config.xml <a href="../../cordova/file/fileobj/fileobj.html">File</a></a> for details.)
XREF -->
...
<tbody>
    ...
    <tr>
        ...
        <td data-col="blackberry10" class="y"></td>
        <td data-col="ios"        class="y"></td>
        <td data-col="winphone7"  class="p">no <a href="../../cordova/file/filetransfer/filetransfer.html"><a href="../../cordova/file/fileobj/fileobj.html">File</a>Transfer</a></td>
        <td data-col="winphone8"  class="p">no <a href="../../cordova/file/filetransfer/filetransfer.html"><a href="../../cordova/file/fileobj/fileobj.html">File</a>Transfer</a></td>
        <td data-col="win8"       class="y"></td>
        <td data-col="tizen"       class="n"></td>
    </tr>
    ...
    <tr>
        ...
        <td data-col="blackberry10" class="y"></td>
        <td data-col="ios"        class="y"></td>
        <td data-col="winphone7"  class="p">local<a href="../../cordova/storage/storage.html">Storage</a> only</td>
        <td data-col="winphone8"  class="p">local<a href="../../cordova/storage/storage.html">Storage</a> only</td>
        <td data-col="win8"       class="y"></td>
        <td data-col="tizen"       class="y"></td>
    </tr>
