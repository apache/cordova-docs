...
For testing in Android, specify the Android source code directory instead (the android source code directory is autogenerated after you build your project targetting the Android platform):
