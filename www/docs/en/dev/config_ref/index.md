...
PreferredContentMode(string) <br/> ==iOS== | *Default: auto* <br/>  Sets the content mode for the webview and inappbrowsers webview on iPads. Valid values are: `mobile` and `desktop`.
