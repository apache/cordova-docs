...
歡迎來到科爾多瓦 Ubuntu <a href="../../support/index.html">平臺支援</a>的初始版本。 此版本中，重點是在 Ubuntu 的系統上開發和使用科爾多瓦 Web 專案開發工作流。 這包括將 Ubuntu 平臺添加到您的專案，添加標準科爾多瓦外掛程式，，當然，建設和運行的 Ubuntu 平臺的應用程式。
