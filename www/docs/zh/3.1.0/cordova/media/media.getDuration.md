...
返回一個音訊<a href="../file/fileobj/fileobj.html">檔</a>的持續時間。
...
`media.getDuration`方法執行同步，以秒為單位，返回該音訊<a href="../file/fileobj/fileobj.html">檔</a>的持續時間，如果已知。如果持續時間是未知的則傳回值為-1。
