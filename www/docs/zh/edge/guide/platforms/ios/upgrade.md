...
本指南演示如何修改 iOS 專案從科爾多瓦的舊版本進行升級。 大多數這些說明適用于與舊集的前面的命令列工具創建的專案 `cordova` CLI 實用程式。 資訊，請參閱<a href="../../cli/index.html">命令列介面</a>如何更新的 CLI 版本。
...
4.  創建一個新專案，如 <a href="tools.html">iOS 殼工具指南</a>中所述。您需要從這個新的專案資產。
...
4.  創建一個新專案，<a href="tools.html">iOS 殼工具指南</a>中所述。你需要從這個新的專案資產。
...
9.  <a href="../../next/index.html">下一步</a>，更新 `CordovaLib` 子專案引用。 開頭科爾多瓦 2.1.0，我們不使用 CORDOVALIB Xcode 變數不再當引用 `CordovaLib` 駐留在何處的引用是絕對檔引用現在。
...
11. <a href="../../next/index.html">下一步</a>，更新 `CordovaLib` 子專案引用。 開頭科爾多瓦 2.1.0，我們不使用 CORDOVALIB Xcode 變數不再當引用 `CordovaLib` 駐留在何處的引用是絕對檔引用現在。
...
2.  創建一個新專案，<a href="tools.html">iOS 殼工具指南</a>中所述。你需要從這個新的專案資產。
