...
`CDVPlugin`類功能其他你的外掛程式可以重寫的方法。 例如，您可以捕獲 `pause` ， `resume` ，應用程式終止和 `handleOpenURL` <a href="../../../cordova/events/events.html">事件</a>。 請參見[CDVPlugin.h][1]和[CDVPlugin.m][2]類的指導。
