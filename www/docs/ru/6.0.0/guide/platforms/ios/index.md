...
*   [Конфигурация iOS](config.html)
*   [Обновление для iOS](upgrade.html)
*   [WebViews в iOS](webview.html)
*   [Плагины для iOS](plugin.html)
*   [Руководство по инструментам командной строки iOS](tools.html)

Средства командной строки относятся к версии Cordova до 3.0. Смотрите раздел "[Интерфейс командной строки](../../cli/index.html)" для информации о текущем интерфейсе интерфейс командной строки.
...
За подробностями о различных требованиях к развертыванию на устройства, обратитесь к секции *Запуск Вашего Приложения На Устройстве (англ.)* публикации Apple's [Процесс Распространения Приложения][9]. Вкратце вам нужно выполнить следующие действия перед развертыванием:
...
*   [Инструменты рабочего процесса руководства для iOS][14]

*   [Руководство пользователя Xcode][15]

*   [Видеосессии][16] от Всемирной Конференции Разработчиков Apple 2012 (WWDC2012)

*   [Команда xcode-select][17], которая помогает указать правильную версию Xcode, если более чем одна версия установлена.
