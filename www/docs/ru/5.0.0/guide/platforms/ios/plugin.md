...
`CDVPlugin`Класса есть другие методы, которые можно переопределить ваш плагин. Например, вы можете захватить `<a href="../../../cordova/events/events.pause.html">pause</a>` , `<a href="../../../cordova/events/events.resume.html">resume</a>` , прервать app и `handleOpenURL` события. См [CDVPlugin.h][1] и [CDVPlugin.m][2] для руководства.
...
## <a href="../../next/index.html">Отладка</a> iOS плагины
...
*   Не забудьте добавить любые узлы, при подключении к в белый список, как описано в "<a href="../../appdev/whitelist/index.html">Инструкция по доступу к внешним ресурсам</a>". Если вы забыли, ошибка регистрируется в консоли Xcode.