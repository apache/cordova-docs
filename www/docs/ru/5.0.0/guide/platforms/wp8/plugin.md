...
Этот раздел содержит сведения о том, как реализовать собственный плагин на платформе Windows Phone. Прежде чем читать этот раздел, смотрите "<a href="../../hybrid/plugins/index.html">Руководство по разработке плагинов</a>" для понимания структуры плагина и его общий интерфейс JavaScript. Этот раздел продолжает демонстрировать образец плагина *echo*, который взаимодействует с WebView Cordova на стороне платформы и наоборот.
...
Смотреть [BaseCommand.cs][1] класс для методов, доступных для плагина для переопределения. Например плагин может перехватывать события «<a href="../../../cordova/events/events.pause.html">pause</a>» и «<a href="../../../cordova/events/events.resume.html">resume</a>».
...
Ниже показано, как использовать `plugin.xml` файла для указания плагин исходных файлов на платформе Windows Phone. См приложение плагины обзор, и "<a href="../../../plugin_ref/spec.html">Спецификация расширений</a>" для подробной информации об имеющихся вариантах.
...
## <a href="../../next/index.html">Отладка</a> плагины
