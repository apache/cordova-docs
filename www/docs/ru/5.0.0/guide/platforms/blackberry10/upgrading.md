...
# <a href="../blackberry/upgrading.html">Модернизация BlackBerry</a> 10
...
6.  Используйте средство CLI cordova для установки любых плагинов, что вам нужно. Обратите внимание, что CLI обрабатывает все основные <a href="../../../cordova/plugins/pluginapis.html">API плагинов</a>, так что они могут и должны быть добавлены. Только плагины отмечены 3.0.0 и выше, совместимы с CLI.
...
6.  Используйте средство CLI cordova для установки любых плагинов, что вам нужно. Обратите внимание, что CLI обрабатывает все основные <a href="../../../cordova/plugins/pluginapis.html">API плагинов</a>, так что они могут и должны быть добавлены. Только 3.0.0 плагины совместимы с CLI.
...
BlackBerry 10 использует новый инструмент CLI и управляет основные API как плагины. <a href="../../../index.html">Инструкции</a> по миграции проекта в новый проект, а не обновление существующего проекта, в связи со сложностью обновления старого проекта. Также обратите внимание, что Кордова js скрипт файл теперь называется «cordova.js» и больше не содержит строку версии.
