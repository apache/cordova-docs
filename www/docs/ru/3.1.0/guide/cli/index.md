...
*   [Камера](../../cordova/camera/camera.html), воспроизведение мультимедиа и захват:
...
*   [Уведомление](../../cordova/notification/notification.html) через диалоговое окно или вибрации:
    
        $ cordova plugin add org.apache.cordova.dialogs
        $ cordova plugin add org.apache.cordova.vibration
        

*   [Контакты](../../cordova/contacts/contacts.html):
    
        $ cordova plugin add org.apache.cordova.contacts
        

*   [Глобализация](../../cordova/globalization/globalization.html):
    
        $ cordova plugin add org.apache.cordova.globalization
        

*   [Экран-заставка](../../cordova/splashscreen/splashscreen.html):
