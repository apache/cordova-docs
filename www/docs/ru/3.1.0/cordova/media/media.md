...
*   **<a href="Parameters/mediaError.html">mediaError</a>**: (необязательно) обратного вызова, который выполняется при возникновении ошибки. *(Функция)*
...
*   `<a href="media.getCurrentPosition.html">media.getCurrentPosition</a>`: Возвращает текущую позицию в аудиофайл.

*   `<a href="media.getDuration.html">media.getDuration</a>`: Возвращает продолжительность звукового файла.
...
*   `<a href="media.release.html">media.release</a>`: Выпускает аудио ресурсы базовой операционной системы.

*   `<a href="media.seekTo.html">media.seekTo</a>`: Перемещает положение в пределах звукового файла.

*   `<a href="media.setVolume.html">media.setVolume</a>`: Задайте громкость воспроизведения звука.

*   `<a href="media.startRecord.html">media.startRecord</a>`: Начните запись звукового файла.

*   `<a href="media.stop.html">media.stop</a>Record`: Остановите запись аудио файлов.

*   `<a href="media.stop.html">media.stop</a>`: Остановка воспроизведения звукового файла.
