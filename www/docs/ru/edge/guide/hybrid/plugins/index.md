...
Другие разработчики могут установить ваш плагин автоматически с помощью `plugman` или Cordova CLI. (Подробную информацию о каждом пути разработки, см. "<a href="../../../plugin_ref/plugman.html">Использование Plugman для управления расширениями</a>" и "<a href="../../cli/index.html">Интерфейс командной строки</a>".)
