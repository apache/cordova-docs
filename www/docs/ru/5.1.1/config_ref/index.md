...
Смотрите подробную информацию о том, как определить каждую функции в разделе Справочник API. Также смотрите [Руководство по разработке плагинов](../guide/hybrid/plugins/index.html) для получения дополнительной информации по плагинам.
