...
La `CDVPlugin` classe dispone di altri metodi che possono eseguire l'override del vostro plugin. Ad esempio, è possibile catturare il `<a href="../../../cordova/events/events.pause.html">pause</a>` , `<a href="../../../cordova/events/events.resume.html">resume</a>` , app terminare e `handleOpenURL` eventi. Vedere la classe [CDVPlugin.h][1] e [CDVPlugin.m][2] per l'orientamento.
