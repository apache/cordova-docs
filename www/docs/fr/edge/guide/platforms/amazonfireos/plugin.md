...
Suivez les instructions fournies dans le Guide de <a href="../android/plugin.html">Plugins Android</a> pour une vue d'ensemble du développement de plugins personnalisés.
