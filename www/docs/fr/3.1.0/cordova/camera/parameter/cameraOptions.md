...
*   **popoverOptions**: options pour iOS uniquement qui spécifient l'emplacement de la boîte de dialogue sur iPad. Définie dans`[CameraPopoverOptions](CameraPopoverOptions.html)`.
