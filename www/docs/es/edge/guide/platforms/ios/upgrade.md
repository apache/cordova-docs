...
4.  Crear un nuevo proyecto, como se describe en [iOS Guía de herramientas de Shell](tools.html). Necesitas los activos de este nuevo proyecto.
...
2.  Crear un nuevo proyecto, como se describe en [iOS Guía de herramientas de Shell](tools.html). Necesitas los activos de este nuevo proyecto.
