...
*   Utilizar la vista **Explorador de conexión** para seleccionar el objetivo del despliegue de aplicación: **ventana → <a href="../../../cordova/inappbrowser/inappbrowser.html">Mostrar</a> vista → conexión Explorer**.
