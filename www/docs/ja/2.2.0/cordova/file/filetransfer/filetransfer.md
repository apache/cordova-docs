...
進行中の転送を中止します。 [FileTransferError](../filetransfererror/filetransfererror.html).ABORT_ERR エラーコードを持つ [FileTransferError](../filetransfererror/filetransfererror.html) オブジェクトを伴って onerror コールバックが呼び出されます。
