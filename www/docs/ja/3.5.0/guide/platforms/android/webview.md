...
人造人間に慣れていないしている場合する必要があります最初 <a href="index.html">Android プラットフォーム <a href="../../../index.html">ガイド</a></a>に慣れるお持ち、WebView を埋め込みのより珍しい開発オプションを実行する前にインストールされている最新の人造人間 SDK。 コルドバ 1.9 を皮切りに、人造人間プラットホームに依存している、 `CordovaWebView` 、従来のビルド コンポーネント `CordovaActivity` 1.9 リリース前コンポーネント。
