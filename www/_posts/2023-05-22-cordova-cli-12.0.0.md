...
We have removed the deprecated platfrom **OSX** & **Windows** from the platform listing and removed all platform pinnings so that future platform releases are avaialble to use immedatly.
